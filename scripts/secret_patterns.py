...
HIGH_CONFIDENCE = [
    ...
    ("sourcegraph_token", r"\bsgp_[A-Za-z0-9]{40}|\bsgph_[A-Za-z0-9]{40,}"),
...
# Matched against the expanded, normalized (abspath) path. Built per call so
# tests can override os.environ['HOME'] between calls.
